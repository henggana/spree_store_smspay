...
ActiveRecord::Schema.define(version: 20151111033649) do
  ...
  add_index "spree_smspay_checkouts", ["order_id"], name: "index_spree_smspay_checkouts_on_order_id"
  add_index "spree_smspay_checkouts", ["smspay_mobile_number_id"], name: "index_spree_smspay_checkouts_on_smspay_mobile_number_id"
  ...
  add_index "spree_smspay_mobile_numbers", ["payment_method_id"], name: "index_spree_smspay_mobile_numbers_on_payment_method_id"
  add_index "spree_smspay_mobile_numbers", ["user_id"], name: "index_spree_smspay_mobile_numbers_on_user_id"
