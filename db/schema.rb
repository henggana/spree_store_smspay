...
ActiveRecord::Schema.define(version: 20151111033649) do
  ...
  create_table "spree_smspay_checkouts", force: true do |t|
    t.integer  "reference"
    t.decimal  "amount"
    t.string   "status"
    t.integer  "order_id"
    t.integer  "smspay_mobile_number_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "spree_smspay_checkouts", ["order_id"], name: "index_spree_smspay_checkouts_on_order_id", using: :btree
  add_index "spree_smspay_checkouts", ["smspay_mobile_number_id"], name: "index_spree_smspay_checkouts_on_smspay_mobile_number_id", using: :btree

  create_table "spree_smspay_mobile_numbers", force: true do |t|
    t.integer  "user_id"
    t.integer  "payment_method_id"
  ...
  add_index "spree_smspay_mobile_numbers", ["payment_method_id"], name: "index_spree_smspay_mobile_numbers_on_payment_method_id", using: :btree
  add_index "spree_smspay_mobile_numbers", ["user_id"], name: "index_spree_smspay_mobile_numbers_on_user_id", using: :btree
